...
#    cfm_solver_method: str = '' #'Midpoint' #        gr.Dropdown(choices=["Midpoint", "RK4", "Euler"], value="Midpoint", label="CFM ODE Solver"),
#    cfm_solver_nfe: int = 0 #128 #        gr.Slider(minimum=1, maximum=128, value=64, step=1, label="CFM Number of Function Evaluations"),
...
#    cfm_time_mapping_divisor : int = 0
#    univnet_nc: int = 0
#    lcfm_latent_dim: int = 0
#    lcfm_training_mode: str = ''
#    lcfm_z_scale: int = 0
#    vocoder_extra_dim: int = 0
    ...
    @classmethod
    def load(cls, run_dir, yaml = None): #: Path | None = None):
        hps = []
